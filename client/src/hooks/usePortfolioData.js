...
const fallbackCaseStudies = [
  ...
  },
  {
    ...
    architectureNotes: [
      ...
      'Role-based dashboards for admin, teachers, parents, and students with audit logging',
      'Explainable AI insights layer that highlights anomalies and suggests actions',
      'Modular backend built for compliance and future analytics/ML upgrades',
    ],
    features: [
    ...
    results: [
      'In build: architecture, UI direction, and key modules are in place',
      'Expected: reduced admin load and earlier risk detection for attendance/performance',
      'Early feedback: "control center" feel with clearer visibility for leadership',
    ],
    links: { live: 'https://ai-school-os.vercel.app/', demo: '#case-studies' },
  },
  {
    slug: 'emr',
    title: 'AI-Enhanced EMR System',
